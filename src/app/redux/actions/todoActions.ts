...
const addTodo = (text: string): TodoActionsType => ({
  type: TodoActionsEnum.TODO_ADD_ITEM,
  payload: { text },
});

const toggleTodo = (id: string):ThunkActionType<TodoActionsType> => (dispatch) => {
  dispatch({
...
const deleteTodo = (id: string): ThunkActionType<TodoActionsType> => (dispatch) => {
  dispatch({
...
const updateTodo = (id: string, text: string): ThunkActionType<TodoActionsType> => (dispatch) => {
  dispatch({
