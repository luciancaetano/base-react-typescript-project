...
function DarkModeSwitch(props: DarkModeSwitchProps) {
  ...
  const { colorMode, switchColorMode } = useDarkModeSwitchViewModel(props);

  return (
    <div className={clsx('flex flex-col justify-center ml-3', styles.darkModeSwitch, className)} data-testid={testingID}>
      <input
        type="checkbox"
        name="light-switch"
      ...
      />
      <label className="relative cursor-pointer p-2" htmlFor="light-switch" onClick={switchColorMode}>
